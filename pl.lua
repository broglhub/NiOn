...
ourspot.MouseButton1Down:connect(function()
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(899.079468, 101.489067, 2482.65674, 0.5852018, 2.12163013e-05, 0.810887694, 3.54925724e-08, 1, -2.6189904e-05, -0.810887694, 1.53551591e-05, 0.5852018)
end)
...
bridgebase.MouseButton1Down:connect(function()
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(705.314697, 99.9900055, 2365.11377, -0.0347304828, -8.8478366e-08, 0.999396741, -4.01018418e-09, 1, 8.83924187e-08, -0.999396741, -9.37853573e-10, -0.0347304828)
end)
...
locals.Name = "locals"
locals.Parent = main
locals.BackgroundColor3 = Color3.fromRGB(0,0,0)
...
customteam.Name = "customteam"
customteam.Parent = main
customteam.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
customteam.BorderColor3 = Color3.fromRGB(255, 0, 0)
customteam.Position = UDim2.new(0, 0, 0.516049385, 0)
customteam.Size = UDim2.new(0, 113, 0, 33)
customteam.Font = Enum.Font.SourceSans
customteam.Text = "custom team"
customteam.TextColor3 = Color3.fromRGB(255, 0, 0)
customteam.TextSize = 14.000
customteam.MouseButton1Down:connect(function()
saved = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
...
game.Players.LocalPlayer.VRDevice = "ok"
...
game.Players.LocalPlayer:GetMouse().KeyDown:connect(function(key)
if key == 'v' then
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = Trxshba_g.Character.HumanoidRootPart.CFrame
end
end)
local slot1={"M9"}
local slot2={"M4A1"}
